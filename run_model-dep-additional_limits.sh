...
if [[ $MODEL == "mh125" ]]; then
    ...
    scenario_label="#font[42]{M_{h}^{125} scenario (H,A#rightarrow#tau#tau)}"
    ...
    scenario_label="#font[42]{M_{h}^{125}(#tilde{#chi}) scenario (H,A#rightarrow#tau#tau)}"
    sub_analysis="sm-like-light"
    sm_like_mass="m_h"
    x_title='m_{A} (GeV)'
    mass_histogram_title="m_{h}"
    ...
    scenario_label="#font[42]{M_{h}^{125}(#tilde{#tau}) scenario (H,A#rightarrow#tau#tau)}"
    sub_analysis="sm-like-light"
    sm_like_mass="m_h"
    x_title='m_{A} (GeV)'
    mass_histogram_title="m_{h}"
    ...
    scenario_label="#font[42]{M_{h}^{125}(alignment) scenario (H,A#rightarrow#tau#tau)}"
    sub_analysis="sm-like-light"
    sm_like_mass="m_h"
    x_title='m_{A} (GeV)'
    mass_histogram_title="m_{h}"
    ...
    scenario_label="#font[42]{M_{h_{1}}^{125}(CPV) scenario (^{}h_{2},^{}h_{3}#rightarrow#tau#tau)}"
    sub_analysis="cpv"
    sm_like_mass="m_H1"
    x_title='m_{H^{#plus}} (GeV)'
...
### Negative mu scenarios #####
    ...
    scenario_label="#font[42]{M_{h}^{125 ^{}#mu_{1}#minus} scenario (H,A#rightarrow#tau#tau)}"
    sub_analysis="sm-like-light"
    sm_like_mass="m_h"
    x_title='m_{A} (GeV)'
    mass_histogram_title="m_{h}"
    ...
    scenario_label="#font[42]{M_{h}^{125 ^{}#mu_{2}#minus} scenario (H,A#rightarrow#tau#tau)}"
    sub_analysis="sm-like-light"
    sm_like_mass="m_h"
    x_title='m_{A} (GeV)'
    mass_histogram_title="m_{h}"
    ...
    scenario_label="#font[42]{M_{h}^{125 ^{}#mu_{3}#minus} scenario (H,A#rightarrow#tau#tau)}"
    sub_analysis="sm-like-light"
    sm_like_mass="m_h"
    x_title='m_{A} (GeV)'
    mass_histogram_title="m_{h}"
...
### EFT scenarios #####
    ...
    scenario_label="#font[42]{M_{h,#kern[0.16667]{E}FT}^{125} scenario (H,A#rightarrow#tau#tau)}"
    sub_analysis="sm-like-light"
    sm_like_mass="m_h"
    x_title='m_{A} (GeV)'
    mass_histogram_title="m_{h}"
    ...
    scenario_label="#font[42]{M_{h,#kern[0.16667]{E}FT}^{125}(#tilde{#chi}) scenario (H,A#rightarrow#tau#tau)}"
    sub_analysis="sm-like-light"
    sm_like_mass="m_h"
    x_title='m_{A} (GeV)'
    mass_histogram_title="m_{h}"
...
### hMSSM scenario #####
    ...
    scenario_label="#font[42]{hMSSM scenario (H,A#rightarrow#tau#tau)}"
    sub_analysis="sm-like-light"
    sm_like_mass="m_h"
    x_title='m_{A} (GeV)'
    mass_histogram_title="m_{h}"
