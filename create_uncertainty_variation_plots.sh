...
sig_freeze="MH=1200,r_ggH=0.0031,r_bbH=0.001"
...
case $MODE in
    prefit-shapes)
        ...
        for var in nominal up down; do
            if [[ $var == "nominal" ]]; then
                ...
                freeze="$sig_freeze,$(get_shift $var $UNC)"
            fi
            for era in 2016; do
                ...
                prefit_postfit_shapes_parallel.py --datacard_pattern "${datacarddir}/${era}/htt_em_2_*/combined.txt.cmb" \
                                                  ...
                                                  --output_name prefit_shapes_${UNC}_${var}.root \
                                                  --parallel 8 |& tee ${defaultdir}/logs/extract_model_independent_shapes-combined-${UNC}.log
                prefit_postfit_shapes_parallel.py --datacard_pattern "${datacarddir}/${era}/htt_*_3*/combined.txt.cmb" \
                                                  ...
                                                  --output_name prefit_shapes_${UNC}_${var}.root \
                                                  --parallel 8 |& tee -a ${defaultdir}/logs/extract_model_independent_shapes-combined-${UNC}.log
            ...
            hadd -f ${datacarddir}/combined/cmb/prefit_shapes_${UNC}_${var}.root ${datacarddir}/201?/htt_*/prefit_shapes_${UNC}_${var}.root |& tee -a ${defaultdir}/logs/extract_model_independent_shapes-combined-${UNC}.log
        done
        ;;
    ...
    do-plots)
        ...
        output=${datacarddir}/plots-variations-${UNC}/
        if [[ ! -d "${output}" ]]
        then
            mkdir ${output}
        fi
        ...
        do
            ./plotting/plot_shapes_mssm_variations.py \
                                           -i ${datacarddir}/combined/cmb/prefit_shapes_${UNC}_nominal.root \
                                           -c ${channels[@]} \
                                           -e 2016 \
                                           $OPTION \
                                           --fake-factor \
                                           ...
                                           -o ${output} \
                                           --up-variation ${datacarddir}/combined/cmb/prefit_shapes_${UNC}_up.root \
                                           --down-variation ${datacarddir}/combined/cmb/prefit_shapes_${UNC}_down.root \
                                           ${cmb_flag} \
                                           --name "$UNC"
                                           # --linear
                                           # --x-range 0,200 \
